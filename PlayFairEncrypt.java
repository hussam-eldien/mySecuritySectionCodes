...
package lab5.playfairencrypt;

import java.awt.Point;


public class Lab5PlayFairEncrypt {
...
{   for(j=0;j<5;j++)
 ...
 return new Point(-1,-1);
    ...
    public static String playFairEncrypt(String string,String key) {
       String output=""; int i;
       Point p1=new Point();
       Point p2=new Point();
...
while(i<string.length())
{
 ...
 return true;  } 
  ...
  public static void printMatrix(char[][]keyMatrix)
  {
    ...
    // char [][]res=buildKeyMatrix("zoo");
     String output=playFairEncrypt("generalization","given");
        System.out.println(output);
